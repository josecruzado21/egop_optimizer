...
class SOAP(optim.Optimizer):
    ...
    def __init__(
        ...
        print("[SOAP] Precondition frequency:", defaults["precondition_frequency"])
    ...
    def update_preconditioner(self, grad, state, 
        ...
        if state['precondition_frequency'] > 0:
            if state['step'] > 0 and state['step'] % state['precondition_frequency'] == 0:
                # print(f"[SOAP] precondition_frequency: {state['precondition_frequency']}", flush=True)
                # beginning = time.time()
                ...
                # end = time.time()
                # print(f"[SOAP] Time taken for QR decomposition: {end - beginning} seconds", flush=True)
